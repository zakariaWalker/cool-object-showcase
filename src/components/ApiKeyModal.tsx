    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-card border border-border rounded-sm p-6 w-[440px] shadow-xl" onClick={e => e.stopPropagation()}>
        <div className="flex items-center gap-2 mb-1">
          ...
          <div className="text-[11px] uppercase tracking-widest text-green-400">NVIDIA NIM API</div>
        </div>
        ...
        <a
          ...
          className="text-[11px] text-green-400 underline underline-offset-2 block mb-4"
        >
        ...
        <input
          ...
          placeholder="nvapi-..."
          className="w-full bg-background border border-border rounded-sm px-3 py-2 text-[13px] font-mono focus:outline-none focus:border-green-400/50 mb-3"
          dir="ltr"
        />
        ...
        <div className="flex gap-2">
          <button
            onClick={save}
            disabled={!key.trim()}
            className="flex-1 py-2 bg-green-600 text-white text-[13px] rounded-sm hover:bg-green-500 disabled:opacity-40 transition-colors"
          >
