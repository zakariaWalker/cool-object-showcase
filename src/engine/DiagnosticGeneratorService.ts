  ...
  const pool: DiagnosticExercise[] = [
    {
      ...
      question: isBac
        ? "قالت آمال: $(ln(x))^2 = 2ln(x)$. هل هي محقة؟"
        : isMiddle
          ? "قالت آمال: $(x+5)^2 = x^2 + 25$. هل هي محقة؟"
          : "قالت آمال: $\\sqrt{a+b} = \\sqrt{a} + \\sqrt{b}$. هل هي محقة؟",
    ...
    },
    {
      ...
      kind: "qcm",
      icon: "📐",
      misconception: "عدم إدراك التغير التربيعي للمساحة",
    ...
    },
    {
      ...
      badgeColor: "var(--functions)",
      badgeBg: "rgba(225,29,72,0.08)",
    },
    {
      id: 107,
      type: "logic",
      typeName: "كشف التناقض",
